                ...
                <div class="modal-content">
                    <div class="modal-body">
                                ...
                                <div id="exampleInputGroup2" role="group" class="form-group">
                                    <div>
                                        <input id="password" type="password"
                                            ...
                                            required autocomplete="new-password" placeholder="Ingrese contraseña">
                        ...
                        <div id="exampleInputGroup12" role="group" class="form-group">
                            <div>
                                <input id="phone" type="text" class="form-control" name="phone" required
                                    autocomplete="phone" autocomplete="phone" placeholder="Ingrese número telefónico">
                                @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <h6 class="mb-0">
                            ...
                            <a [routerLink]="" class="text-primary" href="{{ route('login') }}">{{ __('Sign in') }}</a>
                            |
